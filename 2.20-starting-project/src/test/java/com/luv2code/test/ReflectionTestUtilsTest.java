...
public class ReflectionTestUtilsTest {
    ...
    public void studentBeforeEach(){
        studentOne.setFirstname("Erhan");
        studentOne.setLastname("Karaarslan");
        studentOne.setEmailAddress("erhannkaraarslan@gmail.com");
    ...
    public void invokePrivateMethod()          {
        ...
        assertEquals("Erhan 1",ReflectionTestUtils.invokeMethod(studentOne,"getFirstNameAndId"),"Fail private method not call");
