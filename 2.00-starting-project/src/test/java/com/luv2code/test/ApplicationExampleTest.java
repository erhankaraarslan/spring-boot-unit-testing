...
public class ApplicationExampleTest {
    ...
    public void beforeEach() {
        ...
        student.setFirstname("Erhan");
        student.setLastname("Karaarslan");
        student.setEmailAddress("erhannkaraarslan@gmail.com");
    ...
    public void checkNullForStudentGrades(){
        assertNotNull(studentGrades.checkNull(student.getStudentGrades()),"failure - should not be null");
    }
    ...
    public void createStudentWithoutGradesInit(){
        ...
        studentTwo.setFirstname("Merve");
        studentTwo.setLastname("Karaarslan");
        studentTwo.setEmailAddress("merveekaraarslan@gmail.com");
